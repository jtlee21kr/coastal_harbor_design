...
goda_data_master = {
    0.01: {
        0.002: {'x': [0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5, 4.0],
                'y': [0.659, 0.869, 1.176, 1.503, 1.843, 2.187, 2.546, 2.906, 3.18]},
        0.005: {'x': [0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5, 4.0],
                'y': [0.439, 0.698, 1.003, 1.348, 1.712, 2.069, 2.365, 2.497, 2.401]},
        0.01: {'x': [0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5, 4.0],
               'y': [0.335, 0.596, 0.929, 1.283, 1.625, 1.922, 2.083, 2.032, 1.952]},
        0.02: {'x': [0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5, 4.0],
               'y': [0.25, 0.527, 0.873, 1.216, 1.522, 1.743, 1.783, 1.748, 1.717]},
        0.04: {'x': [0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5, 4.0],
               'y': [0.186, 0.487, 0.811, 1.115, 1.369, 1.55, 1.625, 1.649, 1.653]},
        0.08: {'x': [0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5, 4.0],
               'y': [0.149, 0.429, 0.698, 0.944, 1.161, 1.332, 1.448, 1.532, 1.59]},
    },
    0.02: {
        0.002: {'x': [0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5, 4.0],
                'y': [0.684, 0.913, 1.21, 1.546, 1.908, 2.285, 2.668, 3.029, 3.275]},
        0.005: {'x': [0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5, 4.0],
                'y': [0.458, 0.717, 1.041, 1.408, 1.788, 2.154, 2.452, 2.515, 2.392]},
        0.01: {'x': [0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5, 4.0],
               'y': [0.345, 0.615, 0.961, 1.339, 1.705, 1.998, 2.115, 2.082, 1.973]},
        0.02: {'x': [0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5, 4.0],
               'y': [0.253, 0.559, 0.922, 1.273, 1.578, 1.776, 1.788, 1.756, 1.702]},
        0.04: {'x': [0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5, 4.0],
               'y': [0.202, 0.511, 0.856, 1.176, 1.422, 1.585, 1.637, 1.647, 1.645]},
        0.08: {'x': [0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5, 4.0],
               'y': [0.149, 0.45, 0.741, 0.992, 1.195, 1.351, 1.469, 1.553, 1.602]},
    },
    0.033: {
        0.002: {'x': [0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5, 4.0],
                'y': [0.757, 1.002, 1.316, 1.669, 2.055, 2.454, 2.852, 3.215, 3.44]},
        0.005: {'x': [0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5, 4.0],
                'y': [0.504, 0.782, 1.142, 1.511, 1.896, 2.296, 2.581, 2.555, 2.407]},
        0.01: {'x': [0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5, 4.0],
               'y': [0.382, 0.68, 1.042, 1.432, 1.813, 2.114, 2.144, 2.053, 1.963]},
        0.02: {'x': [0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5, 4.0],
               'y': [0.293, 0.609, 0.968, 1.341, 1.686, 1.85, 1.817, 1.769, 1.74]},
        0.04: {'x': [0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5, 4.0],
               'y': [0.233, 0.543, 0.898, 1.229, 1.488, 1.626, 1.655, 1.659, 1.656]},
        0.08: {'x': [0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5, 4.0],
               'y': [0.177, 0.49, 0.794, 1.061, 1.269, 1.411, 1.512, 1.589, 1.654]},
    },
    0.05: {
        # 임의 연장 폐기: 독취 데이터 원본 그대로 사용 (3.7까지만)
        0.002: {'x': [0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5, 3.7],
                'y': [0.85, 1.112, 1.445, 1.823, 2.224, 2.64, 3.048, 3.403, 3.493]},
        0.005: {'x': [0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5, 4.0],
                'y': [0.573, 0.88, 1.248, 1.649, 2.066, 2.471, 2.719, 2.576, 2.413]},
        0.01: {'x': [0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5, 4.0],
               'y': [0.444, 0.76, 1.146, 1.557, 1.955, 2.227, 2.155, 2.038, 1.95]},
        0.02: {'x': [0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5, 4.0],
               'y': [0.331, 0.679, 1.066, 1.452, 1.78, 1.872, 1.8, 1.748, 1.72]},
        0.04: {'x': [0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5, 4.0],
               'y': [0.246, 0.612, 0.985, 1.318, 1.571, 1.648, 1.653, 1.646, 1.644]},
        0.08: {'x': [0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5, 4.0],
               'y': [0.182, 0.542, 0.863, 1.121, 1.314, 1.452, 1.544, 1.606, 1.644]},
    },
    0.1: {
        # 임의 연장 폐기: 독취 데이터 원본 그대로 사용 (2.61까지만)
        0.002: {'x': [0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 2.61], 'y': [1.208, 1.518, 1.927, 2.383, 2.879, 3.388, 3.498]},
        0.005: {'x': [0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5, 4.0],
                'y': [0.822, 1.183, 1.621, 2.115, 2.637, 3.039, 2.884, 2.604, 2.423]},
        0.01: {'x': [0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5, 4.0],
               'y': [0.628, 1.014, 1.472, 1.977, 2.419, 2.393, 2.169, 2.04, 1.959]},
        0.02: {'x': [0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5, 4.0],
               'y': [0.474, 0.865, 1.353, 1.826, 2.034, 1.908, 1.814, 1.761, 1.737]},
        0.04: {'x': [0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5, 4.0],
               'y': [0.371, 0.779, 1.228, 1.594, 1.726, 1.681, 1.658, 1.655, 1.655]},
        0.08: {'x': [0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5, 4.0],
               'y': [0.282, 0.683, 1.044, 1.316, 1.49, 1.583, 1.627, 1.642, 1.648]},
    },
}
...
def plot_authentic_chart_spline(h_H0p_read, read_ratio, user_H0p_L0, tanTheta):
    ...
    decay_lines = {
        ...
        0.02: {
            ...
            'y': [2.74, 2.43, 2.01, 1.90, 1.80, 1.75, 1.70, 1.64, 1.62, 1.59, 1.575, 1.57, 1.58, 1.589, 1.592, 1.61,
                  1.62]
        },
        0.033: {
    ...
    ax.text(0.2, y_max - 0.2, f"  해저경사 {frac_slope} (모사)  ", fontsize=11, fontweight='bold',
            bbox=dict(facecolor='white', edgecolor='black', linewidth=1.2), zorder=5)
...
| **비쇄파시 최대파고** | **{Hmax_non_breaking:.4f} m** | {applied_str_non if applied_str_non else f"참고용 ($1.8 \\times H_{{1/3}}$)"} |
            ...
            if is_breaking:
                st.info(
                    f"💡 **선정 사유:** 전면수심이 환산심해파고의 3배 이하($h/H_0' \\le 3.0$)이므로 **쇄파에 의한 저감을 고려**하여 산정도와 약산식 중 **큰 값**을 최종 선정함.")
            else:
            ...
            * 상대수심 ($h/H_0'$) = **{h_H0p_val:.4f}**
            ...
            st.success(
                f"▶ **산정도 $H_{{\\max}}$** = {graph_ratio:.3f} $\\times$ {verified_H0p:.4f} = **{Hmax_graph:.4f} m**")
            ...
            st.markdown(
                f"- $\\beta_0^*$ = $0.052 \\times (H_0'/L_0)^{{-0.38}} \\times \\exp(20 \\times \\tan\\theta^{{1.5}})$ = **{b0_s:.6f}**")
            st.markdown(f"- $\\beta_1^*$ = $0.63 \\times \\exp(3.8 \\times \\tan\\theta)$ = **{b1_s:.6f}**")
            st.markdown(
                f"- $\\beta_{{\\max}}^*$ = $\\max\\left[1.65,\\ 0.53 \\times (H_0'/L_0)^{{-0.29}} \\times \\exp(2.4 \\times \\tan\\theta)\\right]$ = **{bM_s:.6f}**")
            ...
            """)
            st.success(
                f"▶ **약산식 $H_{{\\max}}$** = $\\min$(Condition 1, Condition 2, Condition 3) = **{Hmax_form:.6f} m**")
